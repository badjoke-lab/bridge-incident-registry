...
const outputPath = "docs/audits/phase3-archive-capture-batch3-candidate-verification.json";

const candidates = [
  ["https://medium.com/conflux-network/shuttleflow-protocol-passes-peckshield-security-audit-fe0aa0f20d27", ["bir_src_000141"], "shuttleflow", "Conflux Network"],
  ["https://medium.com/conflux-network/shuttleflow-enabling-the-future-of-defi-through-true-multi-chain-connection-e60c2bada7d4", ["bir_src_000142"], "shuttleflow", "Conflux Network"],
  ["https://medium.com/conflux-network/shuttleflow-v1-3-0-front-end-upgrade-released-301b2ab59437", ["bir_src_000143"], "shuttleflow", "Conflux Network"],
  ["https://medium.com/pnetwork/introducing-pnetwork-v2-bfa7fcdcedb8", ["bir_src_000085"], "pnetwork", "pNetwork"],
  ["https://medium.com/pnetwork/lessons-learnt-from-the-pgala-exploit-50e686730b98", ["bir_src_000089"], "pnetwork", "pNetwork"],
  ["https://pancakebunny.medium.com/the-next-chapter-dao-9630b2c087b", ["bir_src_000038"], "qubit-qbridge", "Bunny Finance / Team Mound"]
...
const report = {
  ...
  policy: {
    source_scope: "official first-party Medium URLs attached to terminal bridge records",
