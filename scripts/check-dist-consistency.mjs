...
import { checkSeriesDistConsistency } from "./lib/series-dist-consistency.mjs";

const result = checkDistConsistency();
const seriesResult = checkSeriesDistConsistency();
const errors = [...result.errors, ...seriesResult.errors];
if (errors.length > 0) {
...
console.log(`Series dist equality: ${seriesResult.files} files.`);
