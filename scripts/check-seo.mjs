...
assert(sitemap.includes(`<loc>${origin}/stats/</loc>`), "stats route missing from sitemap");
...
assert(fs.existsSync("dist/stats/index.html"), "stats page missing from dist");
...
console.log(JSON.stringify({ html_pages: htmlFiles.length, ga_measurement_id: gaMeasurementId, compare_in_sitemap: true, stats_in_sitemap: true, support_in_sitemap: true, ok: true }));
